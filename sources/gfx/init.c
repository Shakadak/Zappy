...
/*   Updated: 2014/06/07 16:15:09 by jvincent         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	gfx->e.board = SDL_CreateTexture(gfx->e.render, SDL_PIXELFORMAT_ARGB8888, SDL_TEXTUREACCESS_TARGET, MAP_W, MAP_H);
	if (gfx->e.board == NULL)
		return (1);
	return (0);
}
...
int	init_sdl(t_env *gfx)
{
	...
	gfx->e.render = SDL_CreateRenderer(gfx->e.win, -1, SDL_RENDERER_ACCELERATED | SDL_RENDERER_TARGETTEXTURE);
